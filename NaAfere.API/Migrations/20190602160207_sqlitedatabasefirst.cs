...
{
    public partial class sqlitedatabasefirst : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    FootballGames = table.Column<int>(nullable: true),
                    BasketballGames = table.Column<int>(nullable: true),
                    VolleyballGames = table.Column<int>(nullable: true),
                    HockeyGames = table.Column<int>(nullable: true),
                    HandballGames = table.Column<int>(nullable: true),
                    Absences = table.Column<int>(nullable: true),
                    UserId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UStat", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UStat_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Description = table.Column<string>(nullable: true),
                    Waitlist = table.Column<int>(nullable: true),
                    MaxNumbOfPlayers = table.Column<int>(nullable: true),
                    MinNumbOfPlayers = table.Column<int>(nullable: false),
                    GameDate = table.Column<DateTime>(nullable: false),
                    CreateDate = table.Column<DateTime>(nullable: false),
                    Played = table.Column<bool>(nullable: false),
                    Ball = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Game_Disciplines_DisciplineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Post_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Post_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UStatsId = table.Column<int>(nullable: false),
                    GameId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UStatGame", x => new { x.UStatsId, x.GameId });
                    table.ForeignKey(
                        name: "FK_UStatGame_Game_GameId",
                        column: x => x.GameId,
                        principalTable: "Game",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UStatGame_UStat_UStatsId",
                        column: x => x.UStatsId,
                        principalTable: "UStat",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UStat_UserId",
                table: "UStat",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UStatGame_GameId",
                table: "UStatGame",
                column: "GameId");
        }
